...
public class TestServicioUsuarios {
    ...
    public void crearUsuariosValidos() {
        Usuario u1 = srvUsu.crear("adj@asiodjaw.com", "1234", "Nom A", "20");
        Usuario u2 = srvUsu.crear("adj@asiodjaw.com2", "1234", "Nom B", "30");
        Usuario u3 = srvUsu.crear("a@ee.a2", "e1234", "Nom C", "40");
        
        assertTrue(srvUsu.leerUno("adj@asiodjaw.com").getId() > 0);
        assertEquals("Nom B", srvUsu.leerUno("adj@asiodjaw.com2").getNombre());
    ...
    public void modificacionesInvalidasDeUsuarios() {
        Usuario u1 = srvUsu.crear("adj@asiodjaw.comaa", "1234", "Nom A", "20");
        Usuario u2 = srvUsu.crear("adj@asiodjaw.com2", "1234", "Nom B", "30");
        
        srvUsu.modificar(u1.getId(), "@dfdf", u1.getPassword(), u1.getNombre(), "25");
        assertEquals(20, srvUsu.leerUno("adj@asiodjaw.comaa").getEdad());
        
        srvUsu.modificar(u2.getId(), "psdee.dd", u2.getPassword(), u2.getNombre(), "30");
        assertEquals("adj@asiodjaw.com2", srvUsu.leerUno(u2.getId()).getEmail());
        srvUsu.eliminar(u1.getId());
        srvUsu.eliminar(u2.getId());
   }
    @Test
    public void modificarUsuariosValidos() {
        ...
        assertEquals(25, srvUsu.leerUno("adj@asiodjaw.com").getEdad());
    ...
    public void eliminarUsuarios() {
        ...
        assertNull(srvUsu.leerUno("adj@asiodjaw.com"));
    ...
    public void listarTodos() {
        ...
        listaCreados.add(srvUsu.crear("adj@asiodjaw.com", "1234", "Nom A", "20"));
        listaCreados.add(srvUsu.crear("adj@asiodjaw.com2", "1234", "Nom B", "30"));
